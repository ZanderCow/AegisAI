...
const navItems: NavItem[] = [
  ...
  {
    label: 'Flagging Dashboard',
    path: '/security/flags',
    roles: ['security'],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5h14v14H5V5zm3 3h8m-8 4h5m-5 4h8" />
      </svg>
    ),
  },
  {
          ...
          <div className="p-4 border-t border-aegis-800">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                {user.role && <p className="text-xs text-aegis-300 truncate">{user.role}</p>}
              </div>
            </div>
          </div>
        )}
